...
public class RevirwAdapter extends RecyclerView.Adapter<RevirwAdapter.ViewHolder> {
    ...
    private List<FilmCommentBean.ResultBean> list;
    ...
    public void setList(List<FilmCommentBean.ResultBean> data) {
        list.clear();
        if (data!=null){
            list.addAll(data);
        }
    ...
    public void addList(List<FilmCommentBean.ResultBean> data) {
        if (data!=null){
            list.addAll(data);
        }
        notifyDataSetChanged();
