...
public class ShowAdapter extends RecyclerView.Adapter<ShowAdapter.ViewHoder> {
    ...
    public void setCallBack(ShowCallBack back){
        callBack=back;
    }
}
