...
public class FindAllCinemaComment {
    ...
    public static class ResultBean {
         ...
         * isGreat : 0
         */
        private String cinemaComment;

        public String getCinemaComment() {
            return cinemaComment;
        }

        public void setCinemaComment(String cinemaComment) {
            this.cinemaComment = cinemaComment;
        }
