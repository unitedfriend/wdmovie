...
public class EmptyUtil {
    ...
    //注册非空判断
    public static boolean loginNull(String nick,String date,String phone,String email,String pwd){
        return !TextUtils.isEmpty(nick)&&!TextUtils.isEmpty(date)&&!TextUtils.isEmpty(phone)
